...
tellraw @a [{"text":"• /function academy_npcs:trainer/spawn_manual","color":"aqua"},{"text":" - Spawn manuel","color":"white"}]
tellraw @a [{"text":"","color":"white"}]
tellraw @a [{"text":"Configuration des équipes: ","color":"yellow"},{"text":"data/academy_npcs/functions/config/teams.mcfunction","color":"aqua"}]
tellraw @a [{"text":"================================","color":"gold"}]