...
schedule clear academy_npcs:trainer/spawn_random
schedule clear academy_npcs:trainer/manage_interactions

# Retirer tous les dresseurs actifs
execute as @e[type=villager,tag=pokemon_trainer] run function academy_npcs:trainer/despawn_trainer
