...
execute if score #offset_x academy_npcs matches -49..49 if score #offset_z academy_npcs matches -49..49 run function academy_npcs:trainer/attempt_spawn_retry
...
execute if score #spawn_valid academy_npcs matches 0 if score #spawn_attempts academy_npcs matches ..4 run function academy_npcs:trainer/attempt_spawn