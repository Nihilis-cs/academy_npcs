...
$execute positioned $(check_x) 319 $(check_z) run function academy_npcs:trainer/find_surface

# Vérifier si une surface valide a été trouvée
execute if score #found_surface academy_npcs matches 1 run function academy_npcs:trainer/validate_spawn_area