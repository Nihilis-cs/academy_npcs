...
execute if score #found_surface academy_npcs matches 1 run function academy_npcs:trainer/utils/spawn_debug_checks

# Forcer le spawn si surface trouvée (ignore certaines restrictions)
execute if score #found_surface academy_npcs matches 1 run function academy_npcs:trainer/utils/spawn_trainer_validated
