...
execute if score @s battle_check_timer matches ..0 run function academy_npcs:trainer/utils/detect_battle_end
...
execute unless entity @a[distance=..20] run function academy_npcs:trainer/utils/battle_ended